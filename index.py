...
# Page setup
st.set_page_config(page_title='DataChum',
...
with st.sidebar:
    ...
    button_exploratory_data_analysis = st.button(label='**Exploratory Data Analysis**', type='secondary', use_container_width=True)
    button_classification_and_regression = st.button(label='**Classification and Regression**', type='secondary', use_container_width=True)
    button_deployment = st.button(label='**Deployment**', type='secondary', use_container_width=True)
